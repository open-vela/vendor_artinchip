...
#define gt_ggc_m_22xt_registered_function(X) do { \
  if ((intptr_t)(X) != 0) gt_ggc_mx_xt_registered_function (X);\
  } while (0)
extern void gt_ggc_mx_xt_registered_function (void *);
#define gt_ggc_m_34vec_xt_registered_function__va_gc_(X) do { \
  if ((intptr_t)(X) != 0) gt_ggc_mx_vec_xt_registered_function__va_gc_ (X);\
  } while (0)
extern void gt_ggc_mx_vec_xt_registered_function__va_gc_ (void *);
...
#define gt_pch_n_22xt_registered_function(X) do { \
  if ((intptr_t)(X) != 0) gt_pch_nx_xt_registered_function (X);\
  } while (0)
extern void gt_pch_nx_xt_registered_function (void *);
#define gt_pch_n_34vec_xt_registered_function__va_gc_(X) do { \
  if ((intptr_t)(X) != 0) gt_pch_nx_vec_xt_registered_function__va_gc_ (X);\
  } while (0)
extern void gt_pch_nx_vec_xt_registered_function__va_gc_ (void *);
...
extern void gt_pch_p_19vec_odr_type_va_gc_
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_22xt_registered_function
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_34vec_xt_registered_function__va_gc_
    (void *, void *, gt_pointer_operator, void *);
