...
extern rtx maybe_gen_pred_vcpx6 (machine_mode, rtx, rtx, rtx, rtx, rtx, rtx, rtx, rtx);
inline rtx
gen_pred_vcpx6 (machine_mode arg0, rtx x0, rtx x1, rtx x2, rtx x3, rtx x4, rtx x5, rtx x6, rtx x7)
{
  rtx res = maybe_gen_pred_vcpx6 (arg0, x0, x1, x2, x3, x4, x5, x6, x7);
  gcc_assert (res);
  return res;
}
...
extern rtx maybe_gen_pred_vcpx7 (machine_mode, rtx, rtx, rtx, rtx, rtx, rtx, rtx, rtx, rtx);
inline rtx
gen_pred_vcpx7 (machine_mode arg0, rtx x0, rtx x1, rtx x2, rtx x3, rtx x4, rtx x5, rtx x6, rtx x7, rtx x8)
{
  rtx res = maybe_gen_pred_vcpx7 (arg0, x0, x1, x2, x3, x4, x5, x6, x7, x8);
  gcc_assert (res);
  return res;
}
...
extern insn_code maybe_code_for_th_pred_xtheadvfcvt_narrow (int, machine_mode);
inline insn_code
code_for_th_pred_xtheadvfcvt_narrow (int arg0, machine_mode arg1)
{
  insn_code code = maybe_code_for_th_pred_xtheadvfcvt_narrow (arg0, arg1);
  gcc_assert (code != CODE_FOR_nothing);
  return code;
}

extern rtx maybe_gen_th_pred_xtheadvfcvt_narrow (int, machine_mode, rtx, rtx, rtx, rtx, rtx, rtx, rtx, rtx, rtx, rtx);
inline rtx
gen_th_pred_xtheadvfcvt_narrow (int arg0, machine_mode arg1, rtx x0, rtx x1, rtx x2, rtx x3, rtx x4, rtx x5, rtx x6, rtx x7, rtx x8, rtx x9)
{
  rtx res = maybe_gen_th_pred_xtheadvfcvt_narrow (arg0, arg1, x0, x1, x2, x3, x4, x5, x6, x7, x8, x9);
  gcc_assert (res);
  return res;
}

extern insn_code maybe_code_for_th_pred_xtheadvfcvt_rod_trunc (machine_mode);
inline insn_code
code_for_th_pred_xtheadvfcvt_rod_trunc (machine_mode arg0)
{
  insn_code code = maybe_code_for_th_pred_xtheadvfcvt_rod_trunc (arg0);
  gcc_assert (code != CODE_FOR_nothing);
  return code;
}

extern rtx maybe_gen_th_pred_xtheadvfcvt_rod_trunc (machine_mode, rtx, rtx, rtx, rtx, rtx, rtx, rtx, rtx);
inline rtx
gen_th_pred_xtheadvfcvt_rod_trunc (machine_mode arg0, rtx x0, rtx x1, rtx x2, rtx x3, rtx x4, rtx x5, rtx x6, rtx x7)
{
  rtx res = maybe_gen_th_pred_xtheadvfcvt_rod_trunc (arg0, x0, x1, x2, x3, x4, x5, x6, x7);
  gcc_assert (res);
  return res;
}

extern insn_code maybe_code_for_th_pred_xtheadvfcvt_widen (int, machine_mode);
inline insn_code
code_for_th_pred_xtheadvfcvt_widen (int arg0, machine_mode arg1)
{
  insn_code code = maybe_code_for_th_pred_xtheadvfcvt_widen (arg0, arg1);
  gcc_assert (code != CODE_FOR_nothing);
  return code;
}

extern rtx maybe_gen_th_pred_xtheadvfcvt_widen (int, machine_mode, rtx, rtx, rtx, rtx, rtx, rtx, rtx, rtx, rtx);
inline rtx
gen_th_pred_xtheadvfcvt_widen (int arg0, machine_mode arg1, rtx x0, rtx x1, rtx x2, rtx x3, rtx x4, rtx x5, rtx x6, rtx x7, rtx x8)
{
  rtx res = maybe_gen_th_pred_xtheadvfcvt_widen (arg0, arg1, x0, x1, x2, x3, x4, x5, x6, x7, x8);
  gcc_assert (res);
  return res;
}

extern insn_code maybe_code_for_th_pred_xtheadvreduction (int, machine_mode);
inline insn_code
code_for_th_pred_xtheadvreduction (int arg0, machine_mode arg1)
{
  insn_code code = maybe_code_for_th_pred_xtheadvreduction (arg0, arg1);
  gcc_assert (code != CODE_FOR_nothing);
  return code;
}

extern rtx maybe_gen_th_pred_xtheadvreduction (int, machine_mode, rtx, rtx, rtx, rtx);
inline rtx
gen_th_pred_xtheadvreduction (int arg0, machine_mode arg1, rtx x0, rtx x1, rtx x2, rtx x3)
{
  rtx res = maybe_gen_th_pred_xtheadvreduction (arg0, arg1, x0, x1, x2, x3);
  gcc_assert (res);
  return res;
}

extern insn_code maybe_code_for_th_pred_xtheadvreduction_vary (int, machine_mode);
inline insn_code
code_for_th_pred_xtheadvreduction_vary (int arg0, machine_mode arg1)
{
  insn_code code = maybe_code_for_th_pred_xtheadvreduction_vary (arg0, arg1);
  gcc_assert (code != CODE_FOR_nothing);
  return code;
}

extern rtx maybe_gen_th_pred_xtheadvreduction_vary (int, machine_mode, rtx, rtx);
inline rtx
gen_th_pred_xtheadvreduction_vary (int arg0, machine_mode arg1, rtx x0, rtx x1)
{
  rtx res = maybe_gen_th_pred_xtheadvreduction_vary (arg0, arg1, x0, x1);
  gcc_assert (res);
  return res;
}
