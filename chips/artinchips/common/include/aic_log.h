...
#define hal_log_err(fmt, ...) aic_log(LOG_ERR, "E", fmt, ##__VA_ARGS__)
#define hal_log_warn(fmt, ...) aic_log(LOG_WARNING, "W", fmt, ##__VA_ARGS__)
#define hal_log_info(fmt, ...) aic_log(LOG_INFO, "I", fmt, ##__VA_ARGS__)
