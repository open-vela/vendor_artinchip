  ...
  {                                                                            \
    {                                                                          \
      (a) & 0xff, ((a) >> 8) & 0xff, ((a) >> 16) & 0xff, ((a) >> 24) & 0xff,   \
          (b)&0xff, ((b) >> 8) & 0xff, (c)&0xff, ((c) >> 8) & 0xff, (d0),      \
          (d1), (d2), (d3), (d4), (d5), (d6), (d7)                             \
    }                                                                          \
  }

#define DISK_DEFAULT_GUID                                                      \
  EFI_GUID(0xC09F9B8E, 0xAC16, 0x442B, 0x87, 0xC0, 0x68, 0xB6, 0xB7, 0x26,     \
           0x99, 0xB0)
...
struct disk_blk_ops {
  unsigned long (*blk_write)(struct blk_desc *block_dev, u64 start, u64 blkcnt,
                             void *buffer);
