...
#define CFG_BIT_CTRL_EN_VAL(v)                                                 \
  (((v) << CFG_BIT_CTRL_EN_OFS) & CFG_BIT_CTRL_EN_MSK)
#define CFG_BIT_CTRL_MODE_SEL_OFS (1)
#define CFG_BIT_CTRL_MODE_SEL_MSK (1UL << 1)
#define CFG_BIT_CTRL_MODE_SEL_VAL(v)                                           \
  (((v) << CFG_BIT_CTRL_MODE_SEL_OFS) & CFG_BIT_CTRL_MODE_SEL_MSK)
...
#define CFG_BIT_RXIDMA_EN_VAL(v)                                               \
  (((v) << CFG_BIT_RXIDMA_EN_OFS) & CFG_BIT_RXIDMA_EN_MSK)
#define CFG_BIT_TXIDMA_EN_OFS (4)
#define CFG_BIT_TXIDMA_EN_MSK (1UL << 4)
#define CFG_BIT_TXIDMA_EN_VAL(v)                                               \
  (((v) << CFG_BIT_TXIDMA_EN_OFS) & CFG_BIT_TXIDMA_EN_MSK)

#define CFG_BIT_RXFULL_STOP_OFS (7)
#define CFG_BIT_RXFULL_STOP_MSK (1UL << 7)
#define CFG_BIT_RXFULL_STOP_VAL(v)                                             \
  (((v) << CFG_BIT_RXFULL_STOP_OFS) & CFG_BIT_RXFULL_STOP_MSK)
#define CFG_BIT_CTRL_RST_OFS (31)
#define CFG_BIT_CTRL_RST_MSK (1UL << 31)
#define CFG_BIT_CTRL_RST_VAL(v)                                                \
  (((v) << CFG_BIT_CTRL_RST_OFS) & CFG_BIT_CTRL_RST_MSK)
...
#define TCFG_BIT_CS_POL_VAL(v)                                                 \
  (((v) << TCFG_BIT_CS_POL_OFS) & TCFG_BIT_CS_POL_MSK)
#define TCFG_BIT_CS_VALID_CTL_OFS (3)
#define TCFG_BIT_CS_VALID_CTL_MSK (1UL << 3)
#define TCFG_BIT_CS_VALID_CTL_VAL(v)                                           \
  (((v) << TCFG_BIT_CS_VALID_CTL_OFS) & TCFG_BIT_CS_VALID_CTL_MSK)
#define TCFG_BIT_CS_NUM_OFS (4)
#define TCFG_BIT_CS_NUM_MSK (0x3 << 4)
#define TCFG_BIT_CS_NUM_VAL(v)                                                 \
  (((v) << TCFG_BIT_CS_NUM_OFS) & TCFG_BIT_CS_NUM_MSK)
#define TCFG_BIT_CS_CTL_SEL_OFS (6)
#define TCFG_BIT_CS_CTL_SEL_MSK (1UL << 6)
#define TCFG_BIT_CS_CTL_SEL_VAL(v)                                             \
  (((v) << TCFG_BIT_CS_CTL_SEL_OFS) & TCFG_BIT_CS_CTL_SEL_MSK)
#define TCFG_BIT_CS_LEVEL_OFS (7)
#define TCFG_BIT_CS_LEVEL_MSK (1UL << 7)
#define TCFG_BIT_CS_LEVEL_VAL(v)                                               \
  (((v) << TCFG_BIT_CS_LEVEL_OFS) & TCFG_BIT_CS_LEVEL_MSK)
...
#define TCFG_BIT_DMY_VAL_VAL(v)                                                \
  (((v) << TCFG_BIT_DMY_VAL_OFS) & TCFG_BIT_DMY_VAL_MSK)
...
#define TCFG_BIT_RXINDLY_EN_VAL(v)                                             \
  (((v) << TCFG_BIT_RXINDLY_EN_OFS) & TCFG_BIT_RXINDLY_EN_MSK)
#define TCFG_BIT_LSB_EN_OFS (12)
#define TCFG_BIT_LSB_EN_MSK (1UL << 12)
#define TCFG_BIT_LSB_EN_VAL(v)                                                 \
  (((v) << TCFG_BIT_LSB_EN_OFS) & TCFG_BIT_LSB_EN_MSK)
#define TCFG_BIT_RXDLY_DIS_OFS (13)
#define TCFG_BIT_RXDLY_DIS_MSK (1UL << 13)
#define TCFG_BIT_RXDLY_DIS_VAL(v)                                              \
  (((v) << TCFG_BIT_RXDLY_DIS_OFS) & TCFG_BIT_RXDLY_DIS_MSK)
#define TCFG_BIT_TXDLY_EN_OFS (14)
#define TCFG_BIT_TXDLY_EN_MSK (1UL << 14)
#define TCFG_BIT_TXDLY_EN_VAL(v)                                               \
  (((v) << TCFG_BIT_TXDLY_EN_OFS) & TCFG_BIT_TXDLY_EN_MSK)
#define TCFG_BIT_3WIERE_EN_OFS (25)
#define TCFG_BIT_3WIERE_EN_MSK (1UL << 25)
#define TCFG_BIT_3WIERE_EN_VAL(v)                                              \
  (((v) << TCFG_BIT_3WIERE_EN_OFS) & TCFG_BIT_3WIERE_EN_MSK)
#define TCFG_BIT_SLV_OEN_OFS (26)
#define TCFG_BIT_SLV_OEN_MSK (1UL << 26)
#define TCFG_BIT_SLV_OEN_VAL(v)                                                \
  (((v) << TCFG_BIT_SLV_OEN_OFS) & TCFG_BIT_SLV_OEN_MSK)
...
#define FCTL_BIT_RF_WATERMARK_VAL(v)                                           \
  (((v) << FCTL_BIT_RF_WATERMARK_OFS) & FCTL_BIT_RF_WATERMARK_MSK)
#define FCTL_BIT_RF_DREQ_EN_OFS (8)
#define FCTL_BIT_RF_DREQ_EN_MSK (1UL << 8)
#define FCTL_BIT_RF_DREQ_EN_VAL(v)                                             \
  (((v) << FCTL_BIT_RF_DREQ_EN_OFS) & FCTL_BIT_RF_DREQ_EN_MSK)
#define FCTL_BIT_RF_RST_OFS (15)
#define FCTL_BIT_RF_RST_MSK (1UL << 15)
#define FCTL_BIT_RF_RST_VAL(v)                                                 \
  (((v) << FCTL_BIT_RF_RST_OFS) & FCTL_BIT_RF_RST_MSK)
#define FCTL_BIT_TF_WATERMARK_OFS (16)
#define FCTL_BIT_TF_WATERMARK_MSK (0xFFUL << 16)
#define FCTL_BIT_TF_WATERMARK_VAL(v)                                           \
  (((v) << FCTL_BIT_TF_WATERMARK_OFS) & FCTL_BIT_TF_WATERMARK_MSK)
#define FCTL_BIT_TF_DREQ_EN_OFS (24)
#define FCTL_BIT_TF_DREQ_EN_MSK (1UL << 24)
#define FCTL_BIT_TF_DREQ_EN_VAL(v)                                             \
  (((v) << FCTL_BIT_TF_DREQ_EN_OFS) & FCTL_BIT_TF_DREQ_EN_MSK)
#define FCTL_BIT_TF_RST_OFS (31)
#define FCTL_BIT_TF_RST_MSK (1UL << 31)
#define FCTL_BIT_TF_RST_VAL(v)                                                 \
  (((v) << FCTL_BIT_TF_RST_OFS) & FCTL_BIT_TF_RST_MSK)
...
#define FSTS_BIT_RF_CNT_VAL(v)                                                 \
  (((v) << FSTS_BIT_RF_CNT_OFS) & FSTS_BIT_RF_CNT_MSK)
#define FSTS_BIT_RF_RBUF_CNT_OFS (12)
#define FSTS_BIT_RF_RBUF_CNT_MSK (0xFUL << 12)
#define FSTS_BIT_RF_RBUF_CNT_VAL(v)                                            \
  (((v) << FSTS_BIT_RF_RBUF_CNT_OFS) & FSTS_BIT_RF_RBUF_CNT_MSK)
#define FSTS_BIT_RF_RBUF_STS_OFS (15)
#define FSTS_BIT_RF_RBUF_STS_MSK (1UL << 15)
#define FSTS_BIT_RF_RBUF_STS_VAL(v)                                            \
  (((v) << FSTS_BIT_RF_RBUF_STS_OFS) & FSTS_BIT_RF_RBUF_STS_MSK)
#define FSTS_BIT_TF_CNT_OFS (16)
#define FSTS_BIT_TF_CNT_MSK (0xFFUL << 16)
#define FSTS_BIT_TF_CNT_VAL(v)                                                 \
  (((v) << FSTS_BIT_TF_CNT_OFS) & FSTS_BIT_TF_CNT_MSK)
#define FSTS_BIT_TF_WBUF_CNT_OFS (28)
#define FSTS_BIT_TF_WBUF_CNT_MSK (0xFUL << 28)
#define FSTS_BIT_TF_WBUF_CNT_VAL(v)                                            \
  (((v) << FSTS_BIT_TF_WBUF_CNT_OFS) & FSTS_BIT_TF_WBUF_CNT_MSK)
#define FSTS_BIT_TF_WBUF_STS_OFS (31)
#define FSTS_BIT_TF_WBUF_STS_MSK (1UL << 31)
#define FSTS_BIT_TF_WBUF_STS_VAL(v)                                            \
  (((v) << FSTS_BIT_TF_WBUF_STS_OFS) & FSTS_BIT_TF_WBUF_STS_MSK)
...
#define ICR_BIT_ERRS                                                           \
  (ICR_BIT_TF_OVF_INTE | ICR_BIT_RF_UDR_INTE | ICR_BIT_RF_OVF_INTE)
...
#define ICR_BIT_CPU_MSK                                                        \
  (ICR_BIT_ERRS | ICR_BIT_RF_RDY_INTE | ICR_BIT_TF_RDY_INTE |                  \
   ICR_BIT_TDONE_INTE)
...
#define ISTS_BIT_ERRS                                                          \
  (ISTS_BIT_TF_OVF | ISTS_BIT_RF_UDR | ISTS_BIT_RF_OVF | ISTS_BIT_TF_UDR)
...
#define CCFG_BIT_CKDIV2_VAL(v)                                                 \
  (((v) << CCFG_BIT_CKDIV2_OFS) & CCFG_BIT_CKDIV2_MSK)
#define CCFG_BIT_CKDIV1_OFS (8)
#define CCFG_BIT_CKDIV1_MSK (0xFUL << 8)
#define CCFG_BIT_CKDIV1_VAL(v)                                                 \
  (((v) << CCFG_BIT_CKDIV1_OFS) & CCFG_BIT_CKDIV1_MSK)
#define CCFG_BIT_CKDIV_SEL_OFS (12)
#define CCFG_BIT_CKDIV_SEL_MSK (1UL << 12)
#define CCFG_BIT_CKDIV_SEL_VAL(v)                                              \
  (((v) << CCFG_BIT_CKDIV_SEL_OFS) & CCFG_BIT_CKDIV_SEL_MSK)
...
#define TWC_BIT_TXD_CNT_VAL(v)                                                 \
  (((v) << TWC_BIT_TXD_CNT_OFS) & TWC_BIT_TXD_CNT_MSK)

#define TMC_BIT_STXD_CNT_OFS (0)
#define TMC_BIT_STXD_CNT_MSK (0xFFFFFFUL)
#define TMC_BIT_STXD_CNT_VAL(v)                                                \
  (((v) << TMC_BIT_STXD_CNT_OFS) & TMC_BIT_STXD_CNT_MSK)
#define TMC_BIT_DMY_CNT_OFS (24)
#define TMC_BIT_DMY_CNT_MSK (0xFUL << 24)
#define TMC_BIT_DMY_CNT_VAL(v)                                                 \
  (((v) << TMC_BIT_DMY_CNT_OFS) & TMC_BIT_DMY_CNT_MSK)
#define TMC_BIT_DUAL_EN_OFS (28)
#define TMC_BIT_DUAL_EN_MSK (1UL << 28)
#define TMC_BIT_DUAL_EN_VAL(v)                                                 \
  (((v) << TMC_BIT_DUAL_EN_OFS) & TMC_BIT_DUAL_EN_MSK)
#define TMC_BIT_QUAD_EN_OFS (29)
#define TMC_BIT_QUAD_EN_MSK (1UL << 29)
#define TMC_BIT_QUAD_EN_VAL(v)                                                 \
  (((v) << TMC_BIT_QUAD_EN_OFS) & TMC_BIT_QUAD_EN_MSK)
#define TMC_BIT_QUAD_ADDR_EN_OFS (30)
#define TMC_BIT_QUAD_ADDR_EN_MSK (1UL << TMC_BIT_QUAD_ADDR_EN_OFS)
#define TMC_BIT_QUAD_ADDR_EN_VAL(v)                                            \
  (((v) << TMC_BIT_QUAD_ADDR_EN_OFS) & TMC_BIT_QUAD_ADDR_EN_MSK)

#define BTR_BIT_BURST_LINEAR_OFS (0)
#define BTR_BIT_BURST_LINEAR_MSK (0xFFUL << BTR_BIT_BURST_LINEAR_OFS)
#define BTR_BIT_BURST_LINEAR_VAL(v)                                            \
  (((v) << BTR_BIT_BURST_LINEAR_OFS) & BTR_BIT_BURST_LINEAR_MSK)
#define BTR_BIT_BURST_WRAPPED_OFS (8)
#define BTR_BIT_BURST_WRAPPED_MSK (0xFFUL << BTR_BIT_BURST_WRAPPED_OFS)
#define BTR_BIT_BURST_WRAPPED_VAL(v)                                           \
  (((v) << BTR_BIT_BURST_WRAPPED_OFS) & BTR_BIT_BURST_WRAPPED_MSK)
#define BTR_BIT_WRAP_EN_OFS (16)
#define BTR_BIT_WRAP_EN_MSK (1UL << BTR_BIT_WRAP_EN_OFS)
#define BTR_BIT_WRAP_EN_VAL(v)                                                 \
  (((v) << BTR_BIT_WRAP_EN_OFS) & BTR_BIT_WRAP_EN_MSK)
#define BTR_BIT_AUTO_WRAP_LEN_OFS (18)
#define BTR_BIT_AUTO_WRAP_LEN_MSK (1UL << BTR_BIT_AUTO_WRAP_LEN_OFS)
#define BTR_BIT_AUTO_WRAP_LEN_VAL(v)                                           \
  (((v) << BTR_BIT_AUTO_WRAP_LEN_OFS) & BTR_BIT_AUTO_WRAP_LEN_MSK)
...
static inline void qspi_hw_cs_init(u32 base, u32 pol, u32 level,
  ...
  val &=
      ~(TCFG_BIT_CS_POL_MSK | TCFG_BIT_CS_LEVEL_MSK | TCFG_BIT_CS_CTL_SEL_MSK);
 ...
 */
static inline void qspi_hw_set_transfer_cnt(u32 base, u32 txlen,
                                            u32 tx_1line_cnt, u32 rxlen,
                                            u32 hw_dmy_cnt) {
   ...
   *   - If the transfer is DUAL/QUAD mode, the tx_1line_cnt specifies the
   * length that need to send out in single mode, usually for cmd,addr,... #
...
static inline void qspi_hw_set_wrap_len(u32 base, u32 wrap08, u32 wrap16,
                                        u32 wrap32, u32 wrap64) {
  u32 val = 0;

  val |= (WLEN_LEN_BIT_WRAP08_VAL(wrap08) | WLEN_LEN_BIT_WRAP16_VAL(wrap16) |
          WLEN_LEN_BIT_WRAP32_VAL(wrap32) | WLEN_LEN_BIT_WRAP64_VAL(wrap64));
...
static inline int qspi_hw_bit_mode_write(u32 base, const u8 *tx_buf,
                                         u32 tx_bits_len) {
  int dolen, i;
  u32 val, txbits;
  const u8 *p;
