...
#define SDMC_CLKCTRL_DIV_MAX (SDMC_CLKCTRL_DIV_MASK >> SDMC_CLKCTRL_DIV_SHIFT)
...
#define SDMC_DATA_ERR                                                          \
  (SDMC_INT_EBE | SDMC_INT_SBE | SDMC_INT_HLE | SDMC_INT_FRUN | SDMC_INT_EBE | \
   SDMC_INT_DCRC)
...
#define SDMC_IDMAC_INT_MASK                                                    \
  (SDMC_IDMAC_INT_AIS | SDMC_IDMAC_INT_NIS | SDMC_IDMAC_INT_CES |              \
   SDMC_IDMAC_INT_DU | SDMC_IDMAC_INT_FBE | SDMC_IDMAC_INT_RI |                \
   SDMC_IDMAC_INT_TI)
...
struct aic_sdmc_host {
  ...
  u32 is_sdio;
  u32 fifoth_val;
#ifdef CONFIG_AIC_SDMC_IRQ_MODE
...
void hal_sdmc_idma_prepare(struct aic_sdmc_host *host, u32 blksize, u32 blks,
