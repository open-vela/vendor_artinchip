...
FPCLK(CLK_SYSCFG, "syscfg", CLK_OSC24M, PARENT("osc24m"), CLK_SYSCFG_REG, 12,
      -1, 0, 0);
FPCLK(CLK_CODEC, "codec", CLK_AUDIO_SCLK, PARENT("audio_sclk"), CLK_CODEC_REG,
      12, 8, 0, 0);
...
FPCLK(CLK_WDT, "wdt", CLK_OSC32K, PARENT("clk_32k"), CLK_WDT_REG, 12, 8, 0, 0);
...
FPCLK(CLK_PWM, "pwm", CLK_APB1, PARENT("apb1"), CLK_PWM_REG, 12, 8, 0, 0);
FPCLK(CLK_ADCIM, "adcim", CLK_APB1, PARENT("apb1"), CLK_ADCIM_REG, 12, 8, 0, 0);
...
MPCLK(CLK_AUDIO_SCLK, "audio_sclk", audio_src_sels, CLK_AUDIO_REG, -1, 8, 1, 0,
      5);
