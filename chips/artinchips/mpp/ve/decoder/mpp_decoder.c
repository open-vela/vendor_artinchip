...
extern struct mpp_decoder *create_jpeg_decoder(void);
extern struct mpp_decoder *create_png_decoder(void);
extern struct mpp_decoder *create_h264_decoder(void);
extern struct mpp_decoder *create_aicp_decoder(void);
