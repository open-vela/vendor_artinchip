...
enum lvds_mode { NS = 0x0, JEIDA_24BIT = 0x1, JEIDA_18BIT = 0x2 };
...
struct de_funcs {
  int (*set_mode)(struct aic_panel *panel, struct panel_desc *desc,
...
static inline void aic_delay_ms(u32 ms) { usleep(ms * 1000); }

static inline void aic_delay_us(u32 us) { usleep(us); }
