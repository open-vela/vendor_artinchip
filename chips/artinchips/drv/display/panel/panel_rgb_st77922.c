...
static int panel_enable(struct aic_panel *panel) {
  ...
  /* VFP, VBP, Gate line */
  panel_spi_send_seq(0x70, 0x11, 0x9D, 0x11, 0xE0, 0xE0, 0x00, 0x08, 0x75, 0x00,
                     0x00, 0x00, 0x1A);
  /* video mode */
  panel_spi_send_seq(0x71, 0xD3);
  panel_spi_send_seq(0x7B, 0x00, 0x08, 0x08);
  panel_spi_send_seq(0x80, 0x55, 0x62, 0x2F, 0x17, 0xF0, 0x52, 0x70, 0xD2, 0x52,
                     0x62, 0xEA);
  panel_spi_send_seq(0x81, 0x26, 0x52, 0x72, 0x27);
  panel_spi_send_seq(0x84, 0x92, 0x25);
  panel_spi_send_seq(0x86, 0xC6, 0x04, 0xB1, 0x02, 0x58, 0x12, 0x58, 0x10, 0x13,
                     0x01, 0xA5, 0x00, 0xA5, 0xA5);
  panel_spi_send_seq(0x87, 0x10, 0x10, 0x58, 0x00, 0x02, 0x3A);
  panel_spi_send_seq(0x88, 0x00, 0x00, 0x2C, 0x10, 0x04, 0x00, 0x00, 0x00, 0x01,
                     0x01, 0x01, 0x01, 0x01, 0x00, 0x06);
  panel_spi_send_seq(0x89, 0x00, 0x00, 0x00);
  panel_spi_send_seq(0x8A, 0x13, 0x00, 0x2C, 0x00, 0x00, 0x2C, 0x10, 0x10, 0x00,
                     0x3E, 0x19);
  /* VGL Pump */
  panel_spi_send_seq(0x8B, 0x15, 0xB1, 0xB1, 0x44, 0x96, 0x2C, 0x10, 0x97,
                     0x8E);
  /* VGH Pump */
  panel_spi_send_seq(0x8C, 0x1D, 0xB1, 0xB1, 0x44, 0x96, 0x2C, 0x10, 0x50, 0x0F,
                     0x01, 0xC5, 0x12, 0x09);
  ...
  panel_spi_send_seq(0x91, 0x00, 0x44, 0x55, 0x7B, 0x00, 0x40, 0x7F, 0x3F,
                     0x3F);
  panel_spi_send_seq(0x92, 0x00, 0x44, 0x55, 0x2F, 0x00, 0x30, 0x00, 0x05, 0x3F,
                     0x3F);
  panel_spi_send_seq(0x93, 0x00, 0x43, 0x11, 0x3F, 0x00, 0x3F, 0x00, 0x05, 0x3F,
                     0x3F);
  panel_spi_send_seq(0x94, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);

  panel_spi_send_seq(0x95, 0x9D, 0x1D, 0x00, 0x00, 0xFF);
  panel_spi_send_seq(0x96, 0x44, 0x44, 0x07, 0x16, 0x3A, 0x3B, 0x01, 0x00, 0x3F,
                     0x3F, 0x00, 0x40);
  panel_spi_send_seq(0x97, 0x44, 0x44, 0x25, 0x34, 0x3C, 0x3D, 0x1F, 0x1E, 0x3F,
                     0x3F, 0x00, 0x40);
  ...
  panel_spi_send_seq(0x9C, 0x40, 0x12, 0x00, 0x00, 0x00, 0x12, 0x00, 0x00, 0x00,
                     0x12, 0x00, 0x00, 0x00);
  ...
  panel_spi_send_seq(0xB4, 0x10, 0x09, 0x0B, 0x02, 0x00, 0x19, 0x18, 0x13, 0x1E,
                     0x1D, 0x1C, 0x1E);
  panel_spi_send_seq(0xB5, 0x08, 0x12, 0x03, 0x0A, 0x19, 0x01, 0x11, 0x18, 0x1D,
                     0x1E, 0x1E, 0x1C);
  panel_spi_send_seq(0xB6, 0xFF, 0xFF, 0x00, 0x07, 0xFF, 0x0B, 0xFF);
  /* GammaP */
  panel_spi_send_seq(0xB7, 0x00, 0x0B, 0x12, 0x0A, 0x0B, 0x06, 0x37, 0x00, 0x02,
                     0x4D, 0x08, 0x14, 0x14, 0x30, 0x36, 0x0F);
  /* GammaN */
  panel_spi_send_seq(0xB8, 0x00, 0x0B, 0x11, 0x09, 0x09, 0x06, 0x37, 0x06, 0x05,
                     0x4D, 0x08, 0x13, 0x13, 0x2F, 0x36, 0x0F);
