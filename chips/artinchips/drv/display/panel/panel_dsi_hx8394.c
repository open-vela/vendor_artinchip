...
static int panel_enable(struct aic_panel *panel) {
  ...
  panel_dsi_generic_send_seq(panel, 0xba, 0x63, 0x03, 0x68, 0x7b, 0xb2, 0xc0);

  /* 5.19.2 SETPOWER: Set power (B1h) */
  panel_dsi_generic_send_seq(panel, 0xb1, 0x48, 0x0f, 0x6f, 0x09, 0x32, 0x54,
                             0x71, 0x51, 0x57, 0x43);

  /* 5.19.3 SETOFFSET: Set VP_REFS and VN_REF voltage (D2h) */
  panel_dsi_generic_send_seq(panel, 0xd2, 0x00, 0x80, 0x78, 0x0c, 0x0d, 0x22);

  /* 5.19.3 SETDISP: Set display related register (B2h) */
  panel_dsi_generic_send_seq(panel, 0xb2, 0x00, 0x80, 0x78, 0x0c, 0x0d, 0x22,
                             0x00, 0x00, 0x00, 0x00, 0xc8);

  /* 5.19.4 SETCYC: Set display waveform cycles (B4h) */
  panel_dsi_generic_send_seq(panel, 0xb4, 0x69, 0x6a, 0x69, 0x6a, 0x69, 0x6a,
                             0x01, 0x0c, 0x7c, 0x55, 0x00, 0x3f, 0x69, 0x6a,
                             0x69, 0x6a, 0x69, 0x6a, 0x01, 0x0c, 0x7c);

  /* 5.19.5 SETVCOM: Set VCOM voltage (B6h) */
  panel_dsi_generic_send_seq(panel, 0xb6, 0x6e, 0x6e);

  /* 5.19.19 SETGIP0: Set GIP Option0 (D3h) */
  panel_dsi_generic_send_seq(
      panel, 0xd3, 0xd3, 0x00, 0x00, 0x07, 0x07, 0x40, 0x07, 0x0c, 0x00, 0x08,
      0x10, 0x08, 0x54, 0x15, 0xaa, 0x05, 0xaa, 0x02, 0x15, 0x16, 0x06, 0x05,
      0x06, 0x47, 0x44, 0x0a, 0x0a, 0x4b, 0x10, 0x07, 0x07, 0x0c, 0x40);

  /* 5.19.20 Set GIP Option1 (D5h) */
  panel_dsi_generic_send_seq(
      panel, 0xd5, 0x20, 0x18, 0x18, 0x21, 0x26, 0x18, 0x24, 0x27, 0x1c, 0x25,
      0x1d, 0x1c, 0x00, 0x1d, 0x02, 0x01, 0x04, 0x03, 0x18, 0x18, 0x06, 0x05,
      0x18, 0x18, 0x08, 0x07, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18,
      0x18, 0x09, 0x18, 0x18, 0x0a, 0x0b, 0x18, 0x18, 0x18, 0x18);

  /* 5.19.21 Set GIP Option2 (D6h) */
  panel_dsi_generic_send_seq(
      panel, 0xd6, 0x25, 0x18, 0x18, 0x24, 0x27, 0x18, 0x21, 0x26, 0x1c, 0x20,
      0x1D, 0x1c, 0x0b, 0x1d, 0x09, 0x0a, 0x07, 0x08, 0x18, 0x18, 0x05, 0x06,
      0x18, 0x18, 0x03, 0x04, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18,
      0x18, 0x02, 0x18, 0x18, 0x01, 0x00, 0x18, 0x18, 0x18, 0x18);

  /* 5.19.25 SETGAMMA: Set gamma curve related setting (E0h) */
  panel_dsi_generic_send_seq(
      panel, 0xe0, 0x00, 0x22, 0x2c, 0x32, 0x34, 0x38, 0x3b, 0x39, 0x71, 0x7f,
      0x8d, 0x8a, 0x91, 0x9e, 0xa2, 0xa4, 0xad, 0xae, 0xa6, 0xb2, 0xbf, 0x5c,
      0x57, 0x5f, 0x5d, 0x5e, 0x5a, 0x54, 0x5c, 0x00, 0x22, 0x2c, 0x32, 0x34,
      0x38, 0x3b, 0x39, 0x71, 0x7f, 0x8d, 0x8a, 0x90, 0x9f, 0xa0, 0xa3, 0xaf,
      0xaf, 0xa7, 0xb2, 0xbf, 0x5c, 0x59, 0x5f, 0x5e, 0x5e, 0x5c, 0x58, 0x5c);

  /* 5.19.12 SETIOOPT (C0h), Set Source Option */
  panel_dsi_generic_send_seq(panel, 0xc0, 0x1f, 0x31);

  /* 5.19.17 SETPANEL (CCh) */
  panel_dsi_generic_send_seq(panel, 0xcc, 0x03);
  ...
  /* 5.19.26 SETGIP3 (D8h) */
  panel_dsi_generic_send_seq(panel, 0xd8, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
