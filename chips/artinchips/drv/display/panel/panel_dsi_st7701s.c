...
static int panel_enable(struct aic_panel *panel) {
  ...
  /* GAMMA Set */
  panel_dsi_dcs_send_seq(panel, 0xB0, 0x40, 0xC9, 0x91, 0x07, 0x02, 0x09, 0x09,
                         0x1F, 0x04, 0x50);
  panel_dsi_dcs_send_seq(panel, 0x0F, 0xE4, 0x29, 0xDF);
  panel_dsi_dcs_send_seq(panel, 0xB1, 0x40, 0xCB, 0xD0, 0x11, 0x92, 0x07, 0x00,
                         0x08, 0x07, 0x1C);
  ...
  panel_dsi_dcs_send_seq(panel, 0xE1, 0x08, 0x00, 0x0A, 0x00, 0x07, 0x00, 0x09,
                         0x00, 0x00, 0x33, 0x33);
  panel_dsi_dcs_send_seq(panel, 0xE2, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                         0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
  panel_dsi_dcs_send_seq(panel, 0xE3, 0x00, 0x00, 0x33, 0x33);
  panel_dsi_dcs_send_seq(panel, 0xE4, 0x44, 0x44);
  panel_dsi_dcs_send_seq(panel, 0xE5, 0x0E, 0x60, 0xA0, 0xA0, 0x10, 0x60, 0xA0,
                         0xA0, 0x0A, 0x60, 0xA0, 0xA0, 0x0C, 0x60, 0xA0, 0xA0);
  panel_dsi_dcs_send_seq(panel, 0xE6, 0x00, 0x00, 0x33, 0x33);
  panel_dsi_dcs_send_seq(panel, 0xE7, 0x44, 0x44);
  panel_dsi_dcs_send_seq(panel, 0xE8, 0x0D, 0x60, 0xA0, 0xA0, 0x0F, 0x60, 0xA0,
                         0xA0, 0x09, 0x60, 0xA0, 0xA0, 0x0B, 0x60, 0xA0, 0xA0);
  panel_dsi_dcs_send_seq(panel, 0xEB, 0x02, 0x01, 0xE4, 0xE4, 0x44, 0x00, 0x40);
  panel_dsi_dcs_send_seq(panel, 0xEC, 0x02, 0x01);
  panel_dsi_dcs_send_seq(panel, 0xED, 0xAB, 0x89, 0x76, 0x54, 0x01, 0xFF, 0xFF,
