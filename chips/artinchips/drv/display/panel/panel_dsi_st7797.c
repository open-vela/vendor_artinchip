...
static int panel_enable(struct aic_panel *panel) {
  ...
  panel_dsi_dcs_send_seq(panel, 0xE0, 0xD2, 0x09, 0x0C, 0x07, 0x06, 0x23, 0x2E,
                         0x43, 0x46, 0x17, 0x13, 0x13, 0x2D, 0x33);
  panel_dsi_dcs_send_seq(panel, 0xE1, 0xD2, 0x09, 0x0C, 0x07, 0x05, 0x23, 0x2E,
                         0x33, 0x46, 0x17, 0x13, 0x13, 0x2D, 0x33);
  panel_dsi_dcs_send_seq(panel, 0xE5, 0xB5, 0xF5, 0xC9, 0x33, 0x22, 0x25, 0x10,
                         0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55);
  panel_dsi_dcs_send_seq(panel, 0xE6, 0xB5, 0xF5, 0xC9, 0x33, 0x22, 0x25, 0x10,
                         0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55);
  ...
  panel_dsi_dcs_send_seq(panel, 0xA5, 0x00, 0x00, 0x00, 0x00, 0x00, 0x15, 0x2A,
                         0xBA, 0x02);
  panel_dsi_dcs_send_seq(panel, 0xA6, 0x00, 0x00, 0x00, 0x00, 0x00, 0x15, 0x2A,
                         0xBA, 0x02);
  panel_dsi_dcs_send_seq(panel, 0xBA, 0x1A, 0x0A, 0x45, 0x00, 0x23, 0x01, 0x00);
  panel_dsi_dcs_send_seq(panel, 0xBB, 0x00, 0x24, 0x00, 0x2F, 0x83, 0x07, 0x18,
                         0x00);
  panel_dsi_dcs_send_seq(panel, 0xBC, 0x00, 0x24, 0x00, 0x2F, 0x83, 0x07, 0x18,
                         0x00);
  panel_dsi_dcs_send_seq(panel, 0xBD, 0x22, 0x11, 0xFF, 0xFF, 0x55, 0x44, 0x77,
                         0x66, 0xFF, 0xFF, 0x0F);
