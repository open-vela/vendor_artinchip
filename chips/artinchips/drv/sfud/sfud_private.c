...
static const sfud_qspi_flash_private_info qspi_flash_private_info_table[] =
    SFUD_FLASH_PRIVATE_INFO_TABLE;
...
int spi_nor_get_unique_id(sfud_flash *flash, uint8_t *data) {
  ...
  for (int i = 0; i < sizeof(qspi_flash_private_info_table) /
                          sizeof(sfud_qspi_flash_private_info);
       i++) {
