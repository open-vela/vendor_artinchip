...
#define AICFB_GET_LAYER_CAPABILITY                                             \
  _IOWR(IOC_TYPE_FB, 0x22, struct aicfb_layer_capability)

/** get layer config data */
#define AICFB_GET_LAYER_CONFIG _IOWR(IOC_TYPE_FB, 0x23, struct aicfb_layer_data)

/** update layer config data */
#define AICFB_UPDATE_LAYER_CONFIG                                              \
  _IOW(IOC_TYPE_FB, 0x24, struct aicfb_layer_data)

/** update layer config data lists */
#define AICFB_UPDATE_LAYER_CONFIG_LISTS                                        \
  _IOW(IOC_TYPE_FB, 0x25, struct aicfb_config_lists)

/** get layer alpha blendig config */
#define AICFB_GET_ALPHA_CONFIG                                                 \
  _IOWR(IOC_TYPE_FB, 0x26, struct aicfb_alpha_config)

/** update layer alpha blendig config */
#define AICFB_UPDATE_ALPHA_CONFIG                                              \
  _IOW(IOC_TYPE_FB, 0x27, struct aicfb_alpha_config)
...
/** update gamma config */
#define AICFB_UPDATE_GAMMA_CONFIG                                              \
  _IOR(IOC_TYPE_FB, 0x67, struct aicfb_gamma_config)

/** get gamma config */
#define AICFB_GET_GAMMA_CONFIG                                                 \
  _IOR(IOC_TYPE_FB, 0x68, struct aicfb_gamma_config)
