...
#define FPCLK_BASE(_id, _name, _parent_id, _parent_name, _reg, _bus, _mod,     \
...
#define MPCLK_BUS(_id, _name, _parent, _reg, _bus, _mod, _mux, _muxw, _div0,   \
                  _div0w)                                                      \
  MPCLK_DEF(_id, _name, _parent, _reg, _bus, _mod, _mux, _muxw, _div0, _div0w)

#define CPUCLK_DEF(_id, _name, _parent, _reg, _key_val, _key, _keyw, _gate,    \
                   _mux, _muxw, _div0, _div0w)                                 \
...
#define CPUCLK(_id, _name, _parent, _reg, _key_val, _key, _keyw, _gate, _mux,  \
               _muxw, _div0, _div0w)                                           \
  CPUCLK_DEF(_id, _name, _parent, _reg, _key_val, _key, _keyw, _gate, _mux,    \
             _muxw, _div0, _div0w)
