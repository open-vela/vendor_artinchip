 ...
 * with corresponding frequency division coefficients of 1, (DIV + 1), 2,
 * respectively. If shift < 0, wd.div represents the frequency division. If
 * shift >= 0, wd.width represents the width of frequency division in register.
 */
struct table_div {
  s16 shift;
  union {
...
#define MPCLK(_id, _name, _parent, _reg, _table_gates, _mux, _muxw,            \
              _table_div)                                                      \
...
#define AUTHCLK(_id, _name, _parent, _reg, _wr_auth_reg, _key_code, _key,      \
                _keyw, _wr_auth_bit, _table_gates, _mux, _muxw, _table_div)    \
...
#define DISPCLK(_id, _name, _parent_id, _parent_name, _reg, _divn, _nwidth,    \
  ...
  DISPCLK_DEF(_id, _name, _parent_id, _parent_name, _reg, _divn, _nwidth,      \
              _divm, _mwidth, _divl, _lwidth, _pix_divsel, _pix_divsel_width)
