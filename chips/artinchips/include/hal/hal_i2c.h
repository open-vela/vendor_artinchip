...
#define I2C_INTR_MASTER_MASK                                                   \
  (I2C_INTR_RX_UNDER | I2C_INTR_RX_FULL | I2C_INTR_TX_EMPTY |                  \
   I2C_INTR_TX_ABRT | I2C_INTR_STOP_DET)

#define I2C_INTR_SLAVE_MASK                                                    \
  (I2C_INTR_RX_UNDER | I2C_INTR_RX_FULL | I2C_INTR_RD_REQ | I2C_INTR_TX_ABRT | \
   I2C_INTR_RX_DONE | I2C_INTR_START_DET)
...
static inline void hal_i2c_read_data_cmd_with_stop_bit(aic_i2c_ctrl *i2c_dev) {
  writel(I2C_DATA_CMD_READ | I2C_DATA_CMD_STOP,
         i2c_dev->reg_base + I2C_DATA_CMD);
}

static inline unsigned long
hal_i2c_get_receive_fifo_num(aic_i2c_ctrl *i2c_dev) {
...
hal_i2c_read_data_cmd_with_restart_bit(aic_i2c_ctrl *i2c_dev) {
  ...
  reg_val |= I2C_CTL_RESTART_ENABLE;
  writel(reg_val, i2c_dev->reg_base + I2C_CTL);
  writel(I2C_DATA_CMD_READ | I2C_DATA_CMD_RESTART,
         i2c_dev->reg_base + I2C_DATA_CMD);
}
...
static inline void hal_i2c_flags_mask(aic_i2c_ctrl *i2c_dev,
                                      unsigned long flags) {
  writel(flags, i2c_dev->reg_base + I2C_INTR_MASK);
}

static inline void
hal_i2c_enable_sda_scl_stuck_timeout_restore(aic_i2c_ctrl *i2c_dev) {
  uint32_t reg_val;
...
int32_t hal_i2c_master_send_msg(aic_i2c_ctrl *i2c_dev, struct aic_i2c_msg *msg,
                                uint8_t is_last_message);
