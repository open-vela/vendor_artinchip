...
struct qspi_xip_read_cfg {
  ...
  /*
   * When CPU cache is disabled, user can select to enable read command bypass
   * mode
   */
...
int hal_qspi_slave_idma_config(qspi_slave_handle *h,
                               struct qspi_slave_idma_config *cfg);
...
int hal_spi_master_transfer_sync(qspi_master_handle *h,
                                 struct qspi_transfer *t);
int hal_spi_master_transfer_async(qspi_master_handle *h,
                                  struct qspi_transfer *t);
