...
#define OUTPUT_COLOR_DEPTH_SET(r, g, b)                                        \
  ((((~r) & 0x3) << 16) | (((~g) & 0x3) << 8) | ((~b) & 0x3))
...
#define VIDEO_LAYER_INPUT_SIZE_SET(w, h)                                       \
  ((((h)&0x1fff) << 16) | (((w)&0x1fff) << 0))

#define VIDEO_LAYER_STRIDE_SET(p0, p1)                                         \
  ((((p1)&0x1fff) << 16) | (((p0)&0x1fff) << 0))

#define VIDEO_LAYER_TILE_OFFSET0_SET(x, y)                                     \
  ((((y)&0xff) << 16) | (((x)&0xff) << 0))

#define VIDEO_LAYER_TILE_OFFSET1_SET(x, y)                                     \
  ((((y)&0xff) << 16) | (((x)&0xff) << 0))
...
#define UI_LAYER_SIZE_SET(w, h) ((((h)&0x1fff) << 16) | (((w)&0x1fff) << 0))
#define UI_LAYER_COLOER_KEY_SET(x) ((x)&0x00ffffff)
#define UI_LAYER_RECT_CTRL_EN(x) BIT(x)

#define UI_RECT_INPUT_SIZE_SET(w, h)                                           \
  ((((h)&0x1fff) << 16) | (((w)&0x1fff) << 0))

#define UI_RECT_OFFSET_SET(x, y) ((((y)&0x1fff) << 16) | (((x)&0x1fff) << 0))

#define UI_RECT_STRIDE_SET(x) ((x)&0x7fff)

#define BLENDING_BG_COLOR_SET(x) ((x)&0x00ffffff)
#define BLENDING_OUTPUT_SIZE_SET(w, h)                                         \
  ((((h)&0x1fff) << 16) | (((w)&0x1fff) << 0))

#define UI_LAYER_OFFSET_SET(x, y) ((((y)&0x1fff) << 16) | (((x)&0x1fff) << 0))

#define VIDEO_LAYER_OFFSET_SET(x, y)                                           \
  ((((y)&0x1fff) << 16) | (((x)&0x1fff) << 0))
...
#define SCALER0_INPUT_SIZE_SET(w, h)                                           \
  ((((h)&0x1fff) << 16) | (((w)&0x1fff) << 0))

#define SCALER0_OUTPUT_SIZE_SET(w, h)                                          \
  ((((h)&0x1fff) << 16) | (((w)&0x1fff) << 0))
...
#define TIMING_ACTIVE_SIZE_SET(w, h)                                           \
  ((((h)&0x1fff) << 16) | (((w)&0x1fff) << 0))

#define TIMING_H_PORCH_SET(f, b) ((((b)&0x1fff) << 16) | (((f)&0x1fff) << 0))

#define TIMING_V_PORCH_SET(f, b) ((((b)&0x1fff) << 16) | (((f)&0x1fff) << 0))

#define TIMING_SYNC_PLUSE_SET_H_V(h, v)                                        \
  ((((v)&0x7ff) << 16) | (((h)&0x7ff) << 0))

#define TIMING_POL_SET_H_V(h, v) ((((v)&0x1) << 1) | (((h)&0x1) << 0))
