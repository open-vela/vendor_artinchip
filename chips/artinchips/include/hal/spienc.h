...
static inline int spienc_init(void) { return hal_spienc_init(); }
...
static inline void spienc_xip_enable(void) { hal_spienc_xip_enable(); }

static inline void spienc_xip_disable(void) { hal_spienc_xip_disable(); }

static inline void spienc_start(void) { hal_spienc_start(); }

static inline void spienc_stop(void) { hal_spienc_stop(); }

static inline int spienc_check_empty(void) { return hal_spienc_check_empty(); }
